<?php
/**
 * File containing the SqlNgStorageEngineFactory class.
 *
...
class SqlNgStorageEngineFactory
{
    /**
    ...
    /**
     * Registers a field type converter as expected in sqlng storage engine.
    ...
    /**
     * Builds the SqlNg Storage Engine
     *
     * @param \eZ\Publish\Core\Persistence\Legacy\EzcDbHandler $dbhandler
     * @param boolean $deferTypeUpdate
     *
     * @return \eZ\Publish\Core\Persistence\SqlNg\Handler
     */
    public function buildEngine( EzcDbHandler $dbhandler, $deferTypeUpdate )
    {
        $engineClass = $this->container->getParameter( 'ezpublish.api.storage_engine.sqlng.class' );
